...
export declare class SvgParser extends SVGElementWalker<SvgNode> {
    ...
    SVGAttributeMapping: {
        ...
        __parseColor: (val: string, currentColor: string | undefined) => string | undefined;
    };
    SVGTagMapping: {
        ...
        __getPolyPath: (tag: SVGElement) => Promise<PathDValue[]>;
    ...
    parseUnit(val: string | null): number | null;
